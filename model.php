    ...
    public function insert($nim, $nama, $uts, $uas,$tugas)
{
    ...
    $sql = "INSERT INTO tbl_user (nim, nama, uts, uas, tugas, na, status) VALUES ('$nim', '$nama',
...
public function update($nim, $nama, $uts, $tugas,$uas)
{
    $na=$this->na($uts,$tugas,$uas);
    $status=$this->status($na);
    $sql = "UPDATE tbl_user SET nama='$nama', uts='$uts', uas='$uas', tugas='$tugas', na='$na',status='$status' WHERE nim='$nim'";
    $this->conn->query($sql);
}
